...
namespace FMS.Data.Services
{
    public static class RehomingServiceSeeder
    {
        ...
        public static void Seed(IRehomingService svc)
        {
            ...
            //add dogs
            var d1 = svc.AddDog("Cocker Spaniel","Freddie","145C",DateTime.Parse("2022-05-02"),"Freddie is a handsome Cocker Spaniel looking for a home that can provide him with lots of physical and mental enrichment. He is a very intelligent boy who loves playing with his toys and going out exploring new places.",
            ...
            var d5 = svc.AddDog("Schnauzer","Max","469B",DateTime.Parse("2020-08-11"),"Max likes having his own space and can sometimes be uncomfortable being handled, he would like a home with calm owners and no children. He is a happy little man and he loves his walks! He likes to explore and have a sniff in amongst the leaves and the tall grass. Max would need to be the only pet in the home as he prefers the company of his family rather than other dogs.",
                                    "https://media-be.chewy.com/wp-content/uploads/2021/06/24103725/MiniatureSchnauzer-FeaturedImage-1024x615.jpg");

            var d6 = svc.AddDog("Husky","Koda","378D",DateTime.Parse("2021-05-12"),"Koda is a sweetheart who loves people and he is an absolute pleasure to care for.He is good to be left for a few hours and good to travel. Koda loves his home comforts, he melts on the sofa and is waiting to melt your heart!",
                                    "https://cdn.britannica.com/84/232784-050-1769B477/Siberian-Husky-dog.jpg");
            var d7 = svc.AddDog("Bichon Frise","Flossy","267H",DateTime.Parse("2021-04-17"),"Flossy is looking for a moderately busy, adult-only home where she can have access to her own secure garden so that she's got a chance to explore and play. Flossy needs a home with no visiting children and would appreciate not having lots of people coming and going whilst she settles in. Her leaving hours need to be built up in a gradual way so that she's got a chance to get used to being in new surroundings. ",
            ...
            var d8 = svc.AddDog("Grey Hound","Finn","244G",DateTime.Parse("2020-04-03"),"Finn is an ex racing Greyhound and most likely has never been in a home so he will need help settling into a domestic life. Ideally he would have access to his own secure garden for house training and zoomies whenever he likes. ",
            ...
            var d9 = svc.AddDog("Bassett Hound","Winston","463E",DateTime.Parse("2018-06-21"),"Winston is looking for a quiet, adult only home. He's a friendly boy and enjoys a fuss on his terms. He will need his own area of the home where he can go for alone time when he wants it, and also where he can sleep without being disturbed.",
